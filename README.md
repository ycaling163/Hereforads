...
**卖家违约时管理员可以强制扣回**:只在违约这种情况下,管理员可以不经卖家同意发起撤回;卖家 Stripe 余额不够时,先从他之后的收入里扣,金额大的尝试从卖家绑定的银行账户扣款(Stripe 负余额自动扣款),同时暂停账号。"金额大"的门槛待定(提议 £100)。
...
- 卖家违约时"金额大、尝试从卖家银行账户扣款"的门槛(提议 £100)
- 消费者 14 天取消权的具体条款措辞要找律师确认(做法已定,见下面第 10 条)
